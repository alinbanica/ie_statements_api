...
RSpec.describe StatementItem, type: :model do
  ...
  describe "validations" do
    ...
    it "is invalid with an item_type not in the list" do
      statement_item = build(:statement_item, statement: statement, item_type: 'invalid_type')
    ...
    it "is valid with item_type as income" do
      statement_item = build(:statement_item, statement: statement, item_type: StatementItem::ItemTypes::INCOME)
      expect(statement_item).to be_valid
    end

    it "is valid with item_type as income" do
      statement_item = build(:statement_item, statement: statement, item_type: StatementItem::ItemTypes::EXPEDITURE)
      expect(statement_item).to be_valid
    end
